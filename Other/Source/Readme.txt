...
user in an INI file next to MyPaintPortable.exe called MyPaintPortable.ini.
...
copy AppNamePortable.ini from this directory to MyPaintPortable.ini next to
MyPaintPortable.exe. The options in the INI file are as follows:
